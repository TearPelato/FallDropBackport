...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.STAIRS)
                ...
                .add(ModBlocks.getResourceKey(ModBlocks.WHITE_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.LIGHT_GRAY_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.GRAY_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.BLACK_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.BROWN_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.RED_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.ORANGE_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.YELLOW_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.LIME_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.GREEN_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.CYAN_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.LIGHT_BLUE_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.BLUE_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.PURPLE_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.MAGENTA_CONCRETE_STAIRS.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.PINK_CONCRETE_STAIRS.get()));
        ...
        tag(BlockTags.SLABS)
                ...
                .add(ModBlocks.getResourceKey(ModBlocks.WHITE_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.LIGHT_GRAY_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.GRAY_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.BLACK_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.BROWN_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.RED_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.ORANGE_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.YELLOW_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.LIME_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.GREEN_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.CYAN_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.LIGHT_BLUE_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.BLUE_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.PURPLE_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.MAGENTA_CONCRETE_SLAB.get()))
                .add(ModBlocks.getResourceKey(ModBlocks.PINK_CONCRETE_SLAB.get()));
