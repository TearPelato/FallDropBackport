...
public class ModBlockTagsProvider extends FabricTagsProvider.BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.STAIRS)
                ...
                .add(Constants.getBlockKey(ModBlocks.WHITE_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.LIGHT_GRAY_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.GRAY_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.BLACK_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.BROWN_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.RED_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.ORANGE_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.YELLOW_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.LIME_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.GREEN_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.CYAN_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.LIGHT_BLUE_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.BLUE_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.PURPLE_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.MAGENTA_CONCRETE_STAIRS))
                .add(Constants.getBlockKey(ModBlocks.PINK_CONCRETE_STAIRS));
        ...
        tag(BlockTags.SLABS)
                ...
                .add(Constants.getBlockKey(ModBlocks.WHITE_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.LIGHT_GRAY_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.GRAY_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.BLACK_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.BROWN_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.RED_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.ORANGE_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.YELLOW_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.LIME_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.GREEN_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.CYAN_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.LIGHT_BLUE_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.BLUE_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.PURPLE_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.MAGENTA_CONCRETE_SLAB))
                .add(Constants.getBlockKey(ModBlocks.PINK_CONCRETE_SLAB));
